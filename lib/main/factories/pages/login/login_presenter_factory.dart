...
import 'package:polls_for_devs/main/factories/use_cases/save_current_account_use_case_factory.dart';
...
LoginPresenter makeGetxLoginPresenter() {
  return GetxLoginPresenter(
    authentication: makeRemoteAuthenticationUseCase(),
    validation: makeLoginValidation(),
    saveCurrentAccount: makeLocalSaveCurrentAccountUseCase(),
  );
}
